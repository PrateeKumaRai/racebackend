...
/**
 * Using of @ResponseStatus annotation in the above exception class. This will
 * cause Spring boot to respond with the specified HTTP status code whenever
 * this exception is thrown from the controller
 */
